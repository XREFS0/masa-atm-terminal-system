# MASA ATM Terminal Engine

Interactive ATM terminal workstation supporting PIN authentication and cash transactions
...
```bash
python "Automated Teller Machine System/index.py"
```
